...
class AuthController {
    ...
    static async register(req, res, next) {
        try {
            ...
            await conn.query(AuthQuery.inputUser, [bod.email, passHash, bod.first_name, bod.last_name]);
    ...
    static async setProfile(req, res, next) {
      try {
        ...
        let queryData = await conn.query(AuthQuery.updateUser, [email, value.first_name, value.last_name]);
